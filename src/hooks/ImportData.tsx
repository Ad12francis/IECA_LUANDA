        ...
        try {
          for (const row of results.data as any[]) {
            try {
              ...
              await dataService.addMember(memberData as Member);
              success++;
            } catch (err) {
              failed++;
            }
          ...
          if (err?.message?.includes('quota')) {
            setError("Limite diário de dados atingido (Quota Firebase). Tente novamente amanhã.");
          } else {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-12">
      ...
      <div className="card-base p-10 space-y-8">
        ...
        {error && (
          <div className="p-4 bg-red-50 border border-red-100 rounded-md flex items-center space-x-3 text-red-600">
